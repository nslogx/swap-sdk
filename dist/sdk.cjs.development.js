...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB, factoryAddress, initCodeHash) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token, factoryAddress, initCodeHash), 18, 'Cake-LP', 'Pancake LPs');
  ...
  Pair.getAddress = function getAddress(tokenA, tokenB, factoryAddress, initCodeHash) {
    ...
    if (((_PAIR_ADDRESS_CACHE = PAIR_ADDRESS_CACHE) === null || _PAIR_ADDRESS_CACHE === void 0 ? void 0 : _PAIR_ADDRESS_CACHE[key]) === undefined) {
      ...
      PAIR_ADDRESS_CACHE = _extends({}, PAIR_ADDRESS_CACHE, (_extends2 = {}, _extends2[key] = address.getCreate2Address(factoryAddress, solidity.keccak256(['bytes'], [solidity.pack(['address', 'address'], [token0.address, token1.address])]), initCodeHash), _extends2));
    }
